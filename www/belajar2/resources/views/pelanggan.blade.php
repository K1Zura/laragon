...
<div class="row">
    ...
    <div class="container">
        <div class="input-group mb-3">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahPelanggan">
                Tambah
            </button>
        </div>
        <div class="card">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->telp}}</td>
                            <td>
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updatePelanggan{{$item->id}}">
                                    Update
                                </button>
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?')">Hapus</button>
                            </form>
                                <!-- Modal -->
                                <div class="modal fade" id="updatePelanggan{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
