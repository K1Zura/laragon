...
<body>
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            @if ($tampilAdmin)
            <li class="sidebar-item">
              <a class="sidebar-link" href="/index-pembelian" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
            ...
            @endif
            <li class="sidebar-item">
              <a class="sidebar-link" href="/index-penjualan" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
            ...
            @if ($tampilAdmin)
            <li class="sidebar-item">
              <a class="sidebar-link" href="/suplier" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
  ...
  <script>
    function pengurangan() {
        ...
        dibayar = parseFloat(document.getElementById('dibayar').value);
